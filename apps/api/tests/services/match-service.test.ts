...
describe('MatchService - Group By Date', () => {
  ...
  it('should throw an error if no match was found.', async () => {
    const mockGroupByDateError = spyOn(matchService, 'getMatchesGroupedByDate').mockRejectedValue(Error());
...
describe('MatchService - Group By Stadium', () => {
  ...
  it('should throw an error if no match was found.', async () => {
    const mockGroupByStadiumError = spyOn(matchService, 'getMatchesGroupedByDate').mockRejectedValue(Error());

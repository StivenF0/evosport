...
const req = (p: string, o?: RequestInit) => app.handle(new Request(`http://localhost/ranking${p}`, o));

describe('RankingRoutes', () => {
  afterEach(() => mock.restore());

  const validRankingStats = {
    id: 1, name: 'Brasil', flagUrl: null, played: 3, points: 9,
    wins: 3, draws: 0, losses: 0, goalsFor: 6, goalsAgainst: 1, goalDifference: 5
  };
